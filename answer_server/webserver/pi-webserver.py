#!/usr/bin/env python3
"""
Raspberry Pi Proxmox answer-file webserver.

This serves answer files from local files on the Pi. Proxmox POSTs machine
details to /answer, including network interface MAC addresses. The server
matches those MAC addresses against vars/pve-node.yml and returns
vars/<node>.toml.
"""
...
def main():
    ...
    try:
        ...
        print("=" * 70)
        print("Raspberry Pi Proxmox Answer Webserver Started")
        print("=" * 70)
